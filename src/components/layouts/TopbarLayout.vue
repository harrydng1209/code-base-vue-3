...
import BaseIconSvg from '../base/BaseIconSvg.vue';
import BaseInput from '../base/BaseInput.vue';
import BaseDropdown from '../base/BaseDropdown.vue';
import { notifications } from '@/mocks/topbar-layout.mock';
...
<template>
  <div class="topbar-layout">
    ...
    <section class="topbar-layout__profile">
      <BaseIconSvg
        :path="
          isDark
...
@import '@/assets/styles/layouts/topbar-layout.scss';
</style>
